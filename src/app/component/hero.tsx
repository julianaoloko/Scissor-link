...
export default function Hero() {
  return (
    <div className="h-screen   border bg-gradient-to-r from-cyan-500 to-blue-500 border-dashed min-h-min py-8 item-center mt-10 relative text-center">
      ...
      text-xl text-slate-200 py-6 px-6 w-96 mx-auto">
